...
def parse_args():
    ...
    parser.add_argument('--config_file',
                        ...
                        default='/Net/Groups/BGI/work_3/sindbad/sindbad-preproc/fluxnet_workflow/exp_config.json',
                        required=False)   
...
with open(exp_config['OutPath']['nc_file'] + "/daily/variable_info.json", 'w') as fp:
...
#%% Run model run
from utils.fluxnet_workflow import DataProcessor
print('-------------------------------------------\n'
